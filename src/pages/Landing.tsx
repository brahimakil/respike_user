          ...
          <div className="contact-content">
            ...
            <div className="contact-info">
              ...
              <div className="social-links fade-in">
                <a href="https://www.instagram.com/respikeofficial?igsh=M29xbm51MDE5cDNv" className="social-link" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://t.me/respikeofficial" className="social-link" target="_blank" rel="noopener noreferrer">
                  <svg className="social-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
